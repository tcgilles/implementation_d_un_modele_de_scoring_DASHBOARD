...
class Tests(unittest.TestCase):
    ...
    def test_value_gauge_id_100002(self):
        result = set_value_gauge(100002)
    ...
    def test_incorrect_input_dist_feature_2(self):
        result1 = plot_dist_feature_2(100002, "")
    ...
    def test_incorrect_input_bivariate_graph(self):
        result1 = plot_bivariate_graph(100002, "AMT_CREDIT", "", "Linear", "Linear")
        result2 = plot_bivariate_graph(100002, "", "AMT_INCOME_TOTAL", "Linear", "Linear")
